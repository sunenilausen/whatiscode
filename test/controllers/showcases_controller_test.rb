...
class ShowcasesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post showcases_url, params: { showcase: { description: @showcase.description, image_url: @showcase.image_url, released_at: @showcase.released_at, title: @showcase.title } }
  #   end
  ...
  #   patch showcase_url(@showcase), params: { showcase: { description: @showcase.description, image_url: @showcase.image_url, released_at: @showcase.released_at, title: @showcase.title } }
