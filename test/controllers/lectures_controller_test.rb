...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { body: @lecture.body, number: @lecture.number, title: @lecture.title, workshop_id: @lecture.workshop_id } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { body: @lecture.body, number: @lecture.number, title: @lecture.title, workshop_id: @lecture.workshop_id } }
